...
modified from markushi's android-ui project to use viewcompat correctly to
have action back-ported.
...
```groovy
dependencies {
       compile 'com.github.shareme:gwsaction:library:tag@aar'
