package com.github.shareme.gwsaction.library.action;

import android.graphics.Matrix;
import android.os.Parcel;
import android.os.Parcelable;

import com.github.shareme.gwsaction.library.ActionView;
...
public class Action implements Parcelable {
    ...
    protected List<LineSegment> lineSegments = new ArrayList<>(3);
